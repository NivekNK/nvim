...
return {
    "NivekNK/cmake-tools.nvim",
    branch = "feature-runtime-output-directory",
    dependencies = {
        "nvim-lualine/lualine.nvim",
    },
    config = function()
        Utils.callback_if_ok_msg("cmake-tools", function(cmake_tools)
            cmake_tools.setup(cmake_tools_config)
            require("plugins.cmake.telescope")
        end)
    end,
}
