...
local todo_comments_config = {
    ...
    keywords = {
        ...
        TODO = { icon = icons.done .. " ", color = "info" },
        HACK = { icon = icons.hack .. " ", color = "warning" },
        WARN = { icon = icons.warning .. " ", color = "warning", alt = { "WARNING" } },
        PERF = { icon = icons.right_up .. " ", alt = { "OPTIM", "PERFORMANCE", "OPTIMIZE" } },
        NOTE = { icon = icons.trace .. " ", color = "hint", alt = { "INFO" } },
